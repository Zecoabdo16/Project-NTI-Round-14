...
Acts as the entry point for all patient requests.
...
* Cannot access sensitive patient data without authentication.
* Must route medical questions to Medical Agent.
...
* Must validate appointment availability before booking.
...
Provides informational responses using hospital knowledge.
...
* Can only answer from verified knowledge sources.
* Must escalate emergency situations.

---

## Loyalty & Escalation Agent

### Purpose

Manages patient prioritization and escalations.
...
* Must follow predefined priority rules.
* Must escalate critical requests to human staff.
...
* Support RAG retrieval workflow
